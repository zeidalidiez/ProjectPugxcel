...
export default function TurnHistory() {
  ...
  return (
    <div className="flex flex-col gap-0.5 p-2 border border-terminal-border rounded bg-terminal-surface h-full overflow-y-auto" role="log" aria-live="polite" aria-label="Combat Log">
